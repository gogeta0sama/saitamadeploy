...
import SaitamaRobot.modules.sql.chatbot_sql as ly
import requests
...
__help__ = """
**For text assistant**
 - /Harley <question>: Ask Harley any question and it will give accurate reply. For eg: `/harita where is Taj Mahal`, `/harita what is the age of Virat Kohli` etc..
**For voice assistant**
